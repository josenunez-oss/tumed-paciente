export default function FondoOlas() {
  return (
    <div style={{
      ...
      {/* Misma foto del banner, más difuminada */}
      <div
        style={{
          position: "absolute",
          top: 0,
          ...
          width: "100%",
          height: "100%",
          backgroundImage: "url('https://images.pexels.com/photos/7653084/pexels-photo-7653084.jpeg?auto=compress&cs=tinysrgb&w=1600')",
